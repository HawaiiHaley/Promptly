...
The app gives users thoughtful writing prompts based on what they want to focus on, the tone they want, and how much time they have. After generating a prompt, users can write directly in the app, add an optional next step, save their reflection, return to it later, edit it, export it, or choose whether it stays private or appears on a separate public reflections page.
...
- Generate journal prompts by focus, tone, and time
- Save reflections in the browser
- Add an optional next action to each reflection
- Mark next actions done or return them to "not yet"
...
- Choose whether each reflection stays private or appears on the public page
...
The public reflections page currently shows reflections that the same browser has marked for the public page. For truly public sharing across the internet, the app will eventually need accounts, authentication, and a database.
